def backward_difference_interpolation(x0, h, y_values, x):
    """
    Backward Difference interpolation to estimate y for a given x using equally spaced data points.
...
result = backward_difference_interpolation(x0, h, y_values, x_interpolate)
