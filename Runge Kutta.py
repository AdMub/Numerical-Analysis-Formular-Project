...
def runge_kutta_4(func, x0, y0, x_end, h):
    """
    Solve a first-order ODE using the fourth-order Runge-Kutta method.
...
# User input (similar to the previous examples)
x = sp.symbols('x')
y = sp.Function('y')(x)
...
x_values, y_values = runge_kutta_4(ode_func, x0, y0, x_end, step_size)
