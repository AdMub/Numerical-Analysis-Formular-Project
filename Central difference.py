def central_difference_interpolation(x0, h, y_values, x):
    """
    Central Difference interpolation to estimate y for a given x using equally spaced data points.
...
# Perform Central Difference interpolation
result = central_difference_interpolation(x0, h, y_values, x_interpolate)
