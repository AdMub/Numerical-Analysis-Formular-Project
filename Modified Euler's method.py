...
def modified_euler_method(func, x0, y0, x_end, h):
    """
    Solve a first-order ODE using the Modified Euler (Heun's) method.
...
# User input (similar to the Euler Method example)
...
x_values, y_values = modified_euler_method(ode_func, x0, y0, x_end, step_size)
